...
vim.keymap.set('n', 'se', ':wq<CR>', { noremap = true, silent = true, desc = 'Save and quit' })
vim.keymap.set('n', 'ee', ':q<CR>', { noremap = true, silent = true, desc = 'Quit' })
vim.keymap.set('n', 'fe', ':q!<CR>', { noremap = true, silent = true, desc = 'Force Quit' })
