...
return {
  --TODO: I need to make sure whatever I use at the new gig for frontend stuff is setup properly here
  {
  ...
  -- give oct snacks picker since it wants to use telescope
  {
    "pwntester/octo.nvim",
    opts = {
      picker = "snacks",
